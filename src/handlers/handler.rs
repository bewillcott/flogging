...
impl Handler {
    pub(crate) fn new(&self, name: String) -> Result<Box<dyn HandlerTrait + 'static>, Error> {
...
pub(crate) trait HandlerTrait: Display + Send + Sync {
    ...
    ///
    /// **name**: Used as _key_ into holding store. Maybe used by individual
    /// handlers for others reasons.
